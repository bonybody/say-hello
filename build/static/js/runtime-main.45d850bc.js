!(function (e) {
  function r(r) {
    for (var n, a, i = r[0], l = r[1], c = r[2], s = 0, p = []; s < i.length; s++)
    ...
    if (0 !== t)
      if (t) r.push(t[2]);
        ...
        (i.charset = 'utf-8'),
          ...
          (i.src = (function (e) {
            return a.p + 'static/js/' + ({}[e] || e) + '.' + { 3: '9f21a462' }[e] + '.chunk.js';
          })(e));
        var l = new Error();
        u = function (r) {
  ...
  var i = (this['webpackJsonpsay-hello'] = this['webpackJsonpsay-hello'] || []),
    l = i.push.bind(i);
  (i.push = r), (i = i.slice());
...
//# sourceMappingURL=runtime-main.45d850bc.js.map
