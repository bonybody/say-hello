        ...
        s = function (t, e) {
          var n = function n(i) {
            ('pagehide' !== i.type && 'hidden' !== document.visibilityState) ||
              (t(i), e && (removeEventListener('visibilitychange', n, !0), removeEventListener('pagehide', n, !0)));
          };
          ...
          var n,
            ...
            r = function (t) {
              'first-contentful-paint' === t.name &&
                (s && s.disconnect(),
                t.startTime < i.timeStamp && ((a.value = t.startTime), a.entries.push(t), m.add(a), n()));
            },
            ...
            'pointerdown' == t.type
              ? (function (t, e) {
                  var n = function () {
                    ...
                    a = function () {
                      removeEventListener('pointerup', n, S), removeEventListener('pointercancel', i, S);
                    };
          ...
          var n,
            ...
            v = function (t) {
              t.startTime < r.timeStamp &&
                ((d.value = t.processingStart - t.startTime), d.entries.push(t), m.add(d), n());
            },
            l = c('first-input', v);
          (n = p(t, d, e)),
            l &&
...
//# sourceMappingURL=3.9f21a462.chunk.js.map
